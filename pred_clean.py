...
def parse_args(args=None):
    ...
    parser.add_argument('--model', type=str, default="llama2-7b-chat-4k", choices=["meta-llama/Llama-3.2-3B-Instruct", "llama2-7b-chat-4k", "chatglm2-6b-32k", "tulu-7b", "internlm-7b-8k"])
    ...
    parser.add_argument(
        ...
        type=str,
        default="cc",
        choices=["no", "old", "new", "v2", "gpt", "cc","cc-combined", "cc-k","inv_tr","lin_code", "exponential"],
...
if __name__ == '__main__':
    ...
    model, tokenizer = load_model_and_tokenizer(args.model, model_name, device)
