...
def loop_json(method = None, dataset = 'finance_qa', deltas=None, folder_template = None, \
    ...
    #         base_folder_template = "pred/llama2-7b_old_g0.5_d{:.1f}_temp1.0_fresh_/eval/ce.json"
    #     elif method == "lc" or "heavy_tail":
    #         deltas = [0.2, 0.3, 0.5, 0.7]
    #         #deltas = [0.1, 0.3, 0.4, 0.5, 0.7, 0.8, 0.9, 0.95, 0.98]
    #         base_folder_template = "pred/llama2-7b_lin_code_g0.5_d5.0_temp1.0_d_tile_{}_fresh_/eval/ce.json"
    #         bool_base_folder_0 = True
    #         base_folder_0 = "pred/llama2-7b_lin_code_g0.5_d5.0_temp1.0_fresh_/eval/ce.json"
    #     elif method == "cc":
    #         bool_base_folder_0 = True
    #         base_folder_0 = "pred/llama3-8b_cc-k_g0.5_d5.0_temp1.0_k_2_d_tile_1.0_fresh_/eval/ce.json"
    #         deltas = []
    #     elif method == "baseline":
    #         bool_base_folder_0 = True
    #         base_folder_0 = "pred/llama3-8b_old_g0.5_d0.0_temp1.0_fresh_/eval/ce.json"
    #         deltas = []
...
def helper_func(folder_template, deltas, dataset, method, bool_base_folder_0, base_folder_0, base_folder_0_z=None):
    ...
    if method == 'gumbel' or method == 'inv' or method == 'synthid' or method == 'lc' or method == 'qary':
        ...
        temp_folder_template = folder_template+ f"/z_score/{dataset}_0.5_5.0_3.05_z.jsonl"
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--top_p", type=float, default=0.99, help="Top p value for sampling.")
    ...
    deltas = [0.0, 0.2, 0.3]
    print('deltas', deltas)
    folder_template = f"pred/llama3-8b_lin_code_g0.5_d5.0_temp{args.temperature}" + "_d_tile_{:.1f}_fresh_"+ f"top_p_{args.top_p}"
    bool_base_folder_0 = False 
    base_folder_0 = ""
    ...
    print('#heavy-tail')
    deltas = [0.0,0.2]
    folder_template = f"pred/llama3-8b_heavy_tail_lognormal_g0.5_d5.0_temp{args.temperature}" + "_d_tile_{:.1f}_fresh_" + f"top_p_{args.top_p}" 
    bool_base_folder_0 = False
    base_folder_0 = ""
    helper_func(folder_template, deltas, args.dataset, 'heavy_tail', bool_base_folder_0, base_folder_0)

    # red/green
    print('#red/green')
    deltas = [0.0, 1.0, 2.0, 3.0]
    print('deltas', deltas)
    folder_template = "pred/llama3-8b_old_g0.5_d{:.1f}" + f"_temp{args.temperature}"  + f"_fresh_top_p_{args.top_p}"
    bool_base_folder_0 = False 
    base_folder_0 = ""
    ...
    print('#Gumbel')
    deltas = [0.0]
    folder_template = f"pred/llama3-8b_exponential_g0.5_d5.0_temp{args.temperature}" + "_fresh_" + f"top_p_{args.top_p}"
    bool_base_folder_0 = False 
    base_folder_0 = ""
    ...
    # print('#qary')
    # deltas = [0.0]
    # folder_template = "pred/llama3-8b_q_lin_code_g0.5_d5.0_temp1.0_d_tile_0.0_fresh_top_p_0.99_q_5"
    # bool_base_folder_0 = False 
    # base_folder_0 = ""
    ...
    # print('#synthid')
    # deltas = [0.0]
    # folder_template = "pred/llama3-8b_synthid_g0.5_d5.0_temp1.0_fresh_top_p_0.99"
    # bool_base_folder_0 = False
    # base_folder_0 = ""
    ...
    # print('#inv')
    # deltas = [0.0]
    # folder_template = "pred/llama3-8b_inv_tr_g0.5_d5.0_temp1.0_fresh_top_p_0.99"
    # bool_base_folder_0 = False
    # base_folder_0 = ""
